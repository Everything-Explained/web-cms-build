...
async function buildCMSData(done) {
    ...
    await (0, utilities_1.delayExec)(0)(async () => {
        const [version, entries] = await execBuildData((0, build_methods_1.buildPublicBlog)(`${_dataRoot}/blog/public`), dataVersions.pubBlog.v);
        dataVersions.pubBlog.v = version;
        dataVersions.pubBlog.n = entries[0].date;
    });
    await (0, utilities_1.delayExec)(15)(async () => {
        const [version, entries] = await execBuildData((0, build_methods_1.buildPublicBlog)(`${_dataRoot}/blog/red33m`), dataVersions.r3dBlog.v);
        dataVersions.r3dBlog.v = version;
        dataVersions.r3dBlog.n = entries[0].date;
    });
    (0, utilities_1.delayExec)(30)(async () => {
        const [version, entries] = await execBuildData((0, build_methods_1.buildChangelog)(`${_dataRoot}/changelog`), dataVersions.chglog.v);
        dataVersions.chglog.v = version;
        dataVersions.chglog.n = entries[0].date;
    });
    (0, utilities_1.delayExec)(60)(async () => {
        const [version, entries] = await execBuildData((0, build_methods_1.buildLibraryLit)(`${_dataRoot}/literature/public`), dataVersions.libLit.v);
        dataVersions.libLit.v = version;
        dataVersions.libLit.n = entries[entries.length - 1].date;
    });
    (0, utilities_1.delayExec)(120)(async () => {
        const [version, entries] = await execBuildData((0, build_methods_1.buildRed33mLit)(`${_dataRoot}/literature/red33m`), dataVersions.r3dLit.v);
        dataVersions.r3dLit.v = version;
        dataVersions.r3dLit.n = entries[entries.length - 1].date;
    });
    (0, utilities_1.delayExec)(150)(async () => {
        const [version, entries] = await execBuildData(() => (0, build_methods_1.buildLibraryVideos)(`${_dataRoot}/videos/public`), dataVersions.libVid.v);
        dataVersions.libVid.v = version;
        dataVersions.libVid.n = entries[entries.length - 1].date;
    });
    await (0, utilities_1.delayExec)(180)(async () => {
        const [version, entries] = await execBuildData(() => (0, build_methods_1.buildRed33mVideos)(`${_dataRoot}/videos/red33m`), dataVersions.r3dVid.v);
    ...
    await (await (0, utilities_1.delayExec)(210)(async () => {
        const isUpdated = await (0, build_methods_1.buildHomePage)(`${_dataRoot}`);
